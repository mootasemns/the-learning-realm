...
function TextSummarization() {
    ...
    const handleSendMessage = async () => {
        if (inputText.trim() !== "") {
            ...
            try {
                const response = await fetch("https://9659-91-186-247-233.ngrok-free.app/summarize/", {
                    method: "POST",
                    headers: {
    ...
    const handleBookmarkText = async (text) => {
        if (Token) {
            ...
            try {
                const response = await fetch("https://gp-server-vxwf.onrender.com/api/saved/summaries/", {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
    ...
    return (
        <div className="page-container">
            ...
            <div className="container">
                <div id="ai-service" className="title">Text Summarization</div>
